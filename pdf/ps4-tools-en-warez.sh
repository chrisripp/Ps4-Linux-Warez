...
do_open_url_theflow() {
    xdg-open "https://github.com/theflow0" >/dev/null 2>&1 &
    yad_info "🐙 <b>theflow0 — GitHub</b>

Opening GitHub profile...

<small>theflow0 is one of the central figures of the PS4 Linux project.
His work covers the Linux kernel port to PS4,
development of kexec, low-level drivers
and PlayStation 4 hardware research.

His repos are an essential reference for any
developer working on PS4 Linux.</small>

<tt>https://github.com/theflow0</tt>"
}
export -f do_open_url_theflow
...
Community resources, tutorials, downloads and online help.\n" \
        ...
        \
        --field="":LBL "" \
        --field="<b>— theflow0 — PS4 Linux Developer —</b>":LBL "" \
        --field="  🐙 theflow0 — GitHub (kernel, kexec, low-level PS4 drivers)":BTN 'bash -c "do_open_url_theflow"' \
        --field="  <small><i>Pioneer of Linux on PS4 · hardware research · essential technical reference.</i></small>":LBL "" \
        --field="  <small><tt>https://github.com/theflow0</tt></small>":LBL "" \
        \
        --field="":LBL "" \
        --field="<b>— Ps4-Linux-Warez (triki1 / Hybryde) —</b>":LBL "" \
        --field="  🎮 Ouvrir Ps4-Linux-Warez (hostps4.free.fr)":BTN 'bash -c "do_open_url_warez"' \
        --field="  <small><i>bzImages · Initramfs Vvsx87 · Distributions PS4 (Elive, Debian Trixie, Xubuntu, Peppermint, Manjaro, Fedora 42)</i></small>":LBL "" \
        --field="  ⬇  Gestionnaire de téléchargements Ps4-Linux-Warez":BTN 'bash -c "do_warez_dl_manager"' \
        --field="  <small><tt>http://hostps4.free.fr/Ps4-Linux-Warez/</tt></small>":LBL "" \
        \
        --field="":LBL "" \
...
#========================================================================
# Ps4-Linux-Warez — Gestionnaire de téléchargements
# Scraping live de hostps4.free.fr/Ps4-Linux-Warez/
# Pages : initramfs.html · bzimage.html · review.html + sous-pages distros
#========================================================================
...
do_warez_dl_manager() {
    ...
    # ── Récupération des 3 pages principales + 6 pages distros ────────
    local tmp_init tmp_bzimg tmp_review
    ...
    local p3=$!
    # Stocker les PIDs des curls distros pour ne pas faire un wait nu
    # (qui attendrait aussi YAD et bloquerait jusqu'à fermeture manuelle)
    local distro_pids=()
    ...
    # Fermer la fenêtre spinner maintenant que tout est chargé
    kill "$PID_W" 2>/dev/null; wait "$PID_W" 2>/dev/null
...
for fname, label in distro_names.items():
    html = read(os.path.join(distro_dir, fname))
...
<span foreground='#FFF9C4'><i>Hybryde PS4 Tools — made with passion for the PS4 Linux community</i></span>\n" \
        ...
        \
        --field="  🐙 <b>theflow0</b>":LBL "" \
        --field="  <small>Pionnier incontestable du projet PS4 Linux. Portage du kernel, kexec,\n  drivers bas-niveau, recherche hardware PlayStation 4.\n  Sans son travail fondateur, rien de tout ceci n'existerait.\n  <tt>https://github.com/theflow0</tt></small>":LBL "" \
        \
        --field="  🐙 <b>crashniels</b>":LBL "" \
        --field="  <small>Maintien actif du kernel Linux PS4 (crashniels/linux),\n  support des derniers firmwares, fixes et améliorations continues.\n  <tt>https://github.com/crashniels/linux</tt></small>":LBL "" \
        \
        --field="  🐙 <b>fail0verflow</b>":LBL "" \
        --field="  <small>Équipe de recherche à l'origine des premiers exploits PS4 et du\n  portage Linux historique. Référence absolue dans le homebrew PlayStation.\n  <tt>https://github.com/fail0verflow/ps4-linux</tt></small>":LBL "" \
        \
        --field="  🐙 <b>Al-Azif</b>":LBL "" \
        --field="  <small>PS4 payloads, tools, exploits and valuable resources for the community.\n  <tt>https://github.com/Al-Azif</tt></small>":LBL "" \
        \
        --field="  🐙 <b>feeRnt</b>":LBL "" \
        --field="  <small>Alternative PS4 kernels, experimental branches and extended hardware support.\n  <tt>https://github.com/feeRnt/ps4-linux-12xx</tt></small>":LBL "" \
        \
        --field="  🎮 <b>GoldHEN Team</b>":LBL "" \
        --field="  <small>Development and maintenance of GoldHEN, the most widely used PS4 CFW.\n  <tt>https://github.com/GoldHEN/GoldHEN</tt></small>":LBL "" \
        \
        --field="  🌐 <b>ps4boot</b>":LBL "" \
        --field="  <small>Payloads Linux, kexec, et outils de boot PS4.\n  <tt>https://github.com/ps4boot</tt>  ·  <tt>https://ps4boot.github.io</tt></small>":LBL "" \
        \
        --field="":LBL "" \
        --field="<b><span foreground='#FFD54F'>— Community &amp; Resources —</span></b>":LBL "" \
        \
        --field="  📖 <b>Dionkill</b>":LBL "" \
        --field="  <small>Tutoriel PS4 Linux complet, fichiers pré-compilés, guide All-In-One.\n  Une ressource essentielle pour tous les débutants et confirmés.\n  <tt>https://dionkill.github.io/ps4-linux-tutorial/</tt></small>":LBL "" \
        \
        --field="  🌍 <b>noob404 — PS4Linux.com</b>":LBL "" \
        --field="  <small>Community forum, help, downloads and PS4 Linux resources.\n  <tt>https://ps4linux.com</tt></small>":LBL "" \
        \
        --field="  🔧 <b>baryluk</b>":LBL "" \
        --field="  <small>mesa-build.py script — simplified and documented Mesa compilation.\n  <tt>https://gist.github.com/baryluk/1041204eff4cc4fad6f1508afe67b562</tt></small>":LBL "" \
        \
        --field="  🔓 <b>OpenOrbis</b>":LBL "" \
        --field="  <small>Open source SDK for PS4 homebrew development.\n  <tt>https://github.com/OpenOrbis/OpenOrbis-PS4-Toolchain</tt></small>":LBL "" \
        \
        --field="":LBL "" \
        --field="<b><span foreground='#FFD54F'>— Free software used —</span></b>":LBL "" \
        --field="  <small>• <b>YAD</b> — Yet Another Dialog (interface graphique GTK)\n  • <b>Mesa</b> — drivers OpenGL/Vulkan open source (AMD Liverpool/Gladius)\n  • <b>LLVM/Clang</b> — compilation kernel avec LTO\n  • <b>Linux Kernel</b> — base du projet\n  • <b>GNU/Linux</b> — tout l'écosystème</small>":LBL "" \
        \
        --field="":LBL "" \
        --field="<b><span foreground='#FFD54F'>— Hybryde PS4 Tools —</span></b>":LBL "" \
        --field="  <small><b>Auteur :</b> Triki1 · Communauté Hybryde\n  <b>Objectif :</b> simplifier le travail sur PS4 Linux pour tous,\n  du débutant au développeur kernel.\n\n  <i>Ce projet est un hommage à tous ceux qui ont donné\n  de leur temps pour ouvrir la PlayStation 4 au monde libre.</i>\n\n  🐧 <b>Vive Linux sur PS4 !</b> 🎮</small>":LBL "" \
        \
        --field="":LBL "" \
        --field="  🐙 theflow0 — GitHub":BTN 'bash -c "xdg-open https://github.com/theflow0 &"' \
